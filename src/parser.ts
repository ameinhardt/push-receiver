...
export default class Parser extends EventEmitter {
  ...
  private waitForData() {
    ...
    switch (this.state) {
      case ProcessingState.MCS_VERSION_TAG_AND_SIZE: {
        minBytesNeeded = Variables.kVersionPacketLength + Variables.kTagPacketLength + Variables.kSizePacketLengthMin;
        break;
      }
      case ProcessingState.MCS_TAG_AND_SIZE: {
        minBytesNeeded = Variables.kTagPacketLength + Variables.kSizePacketLengthMin;
        break;
      }
  ...
  private handleGotMessageSize() {
    ...
    // if prev_byte_count >= kSizePacketLengthMax then something else went wrong
